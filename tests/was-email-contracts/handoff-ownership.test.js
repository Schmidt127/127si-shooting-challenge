...
test("072 v4.9.4 enforces empty-week policies and does not call Make/fetch webhook", () => {
  assert.ok(/Version:\s*v4\.9\.4/.test(s072));
...
test("119 v1.10 only arms Send to Make? and does not post webhook", () => {
...
test("118 v2.3 does not create WAS, build HTML, or post webhook; arms sendMode from input", () => {
