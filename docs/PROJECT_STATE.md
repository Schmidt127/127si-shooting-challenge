...
Last updated: **2026-09-14** — Perfect Mike Schmidt sim **PASSED** (`SEASON-SIM-PERFECT-20260914T202231Z-mike-schmidt`, pre-restore **4,980 active XP / 170 events**) and was exact-ID cleaned. Post-restore **4,525** is expected for future-dated simulation streaks under Production `NOW()`, not a failed season. Formulas are Production-normal; PHA is **20**, including Week 9 ×2. **Three-athlete SC-SEASON-SIM-001 remains ready but not executed.** Curriculum Hub is **COMPLETE / PRODUCTION VERIFIED**. Email producer code/version authority is the published Airtable Automation editor / workflow deployment; historical paste queues below are not current instructions. Active roadmap: [`MASTER_REMAINING_WORK_LIST.md`](../MASTER_REMAINING_WORK_LIST.md). Authority: [`CURRENT-TRUTH.md`](./CURRENT-TRUTH.md) · [`AUTHORITY-MAP.md`](./AUTHORITY-MAP.md) · [`127-SI-MASTER-FUTURE-WORK-LIST.md`](./127-SI-MASTER-FUTURE-WORK-LIST.md).
...
> **Production `Automations` tracking table:** usable only as a catalog for Name, Status, and Automation Code labels. It is **not** script-version or published-code authority; use the published Automation editor / workflow deployment instead ([`CURRENT-TRUTH.md`](./CURRENT-TRUTH.md)).
...
**Email overlay (historical 2026-08-19 through 2026-09-11):** Make.com does not handle Shooting Challenge email; Communications Hub → Resend is the send plane, and Automation **077** is retired. The version/paste queue in this paragraph is historical and superseded by the 2026-09-14 published-editor verification. For current producer code/version truth, use the published Airtable Automation editor / workflow deployment and [`CURRENT-TRUTH.md`](./CURRENT-TRUTH.md), not this dated overlay or the tracking-table mirror.
