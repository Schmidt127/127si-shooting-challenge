...
**Last verification (repo):** 2026-09-14 — tip **`47fe2205`** (+ readiness cleanup branch). Live transactional purge **942** disposable IDs — SC + Curriculum Hub outbox/drafts empty; catalog Zoom Meetings ×2 preserved; formulas normal (no SEASON-SIM branches). Packet: [`audits/readiness-20260914/README.md`](./audits/readiness-20260914/README.md). **PR #530 SUPERSEDED — do not merge.** Prior: **#534**/#533 Tier-1 email · **#531** 010724Z closeout · **#521** SEO. Curriculum Hub Production base **`appnrW8pPpzq8Nhov`** (origin/main `76db1a3`). Email allowlist for sim: **`schmidt@fairfieldbasketballclub.com`**. Prod ahead of GitHub on **035 / 053 / 065** — sync before execute. **THREE-ATHLETE SIMULATION — NOT EXECUTED.** **SC-SEASON-SIM-002** CLOSED. **FUT-048** deferred.
