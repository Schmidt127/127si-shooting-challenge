...
#### Changed
- **Email producer boolean paste versions (2026-09-14)** — Production-paste bump after PR #542 parser: **071 v4.7**, **072 v4.9.4**, **073 v4.11**, **074 v3.8**, **076 v8.17**, **078A v1.9**, **117 v2.4**, **118 v2.3**, **119 v1.10**. Paste bundles under `docs/deploy-checklists/*-PASTE.txt`. Checklist: [`docs/deploy-checklists/EMAIL-PRODUCER-BOOLEAN-INPUT-PARSING.md`](./docs/deploy-checklists/EMAIL-PRODUCER-BOOLEAN-INPUT-PARSING.md). **Production paste pending Mike approval. No simulation executed.**
- **Email producer boolean input parsing (2026-09-14)** — Replaces `Boolean(cfg.testMode)` (and similar) so Airtable text `"false"` is false. Shared `parseAutomationBoolean` / `parseAutomationSendMode` inlined into **071**, **072**, **073**, **074**, **076**, **078A**, **117**, **118**, **119**. Triggers and recipient routing unchanged. Checklist: [`docs/deploy-checklists/EMAIL-PRODUCER-BOOLEAN-INPUT-PARSING.md`](./docs/deploy-checklists/EMAIL-PRODUCER-BOOLEAN-INPUT-PARSING.md). **Merged as PR #542 (`1ac4cea7`).**
...
#### Added
- **Production Automation Reconciliation + Capacity Plan (2026-07-23)** — Docs-only audit: matrix, classifications, and staged ≤50 plan. Confirms **030 does not absorb 032/033**; **063/111/070c** not safe to remove; safest first PROD slot free is delete **112** then install **115**. No Airtable automation mutations. [`PROD-AUTOMATION-VERSION-INVENTORY-2026-07-23.md`](./docs/foundation-reset/PROD-AUTOMATION-VERSION-INVENTORY-2026-07-23.md).
...
- **C-013 Production Lambda minimal contract (2026-07-08)** — [C-013 production promotion plan](./docs/deploy-checklists/C-013-production-promotion-plan.md).
...
- **Production Lambda deploy/test prep (2026-07-08)** — `127si-upload-asset` code-only deploy flags, Function URL invoke helper, [production Lambda deployment checklist](./docs/deploy-checklists/C-013-prod-lambda-deployment-2026-07-11.md). No AWS deploy in commit.
...
#### Added
- **066 v3.1 Production deploy checklist** — historical V2-015 evidence; current operational routing is in [`docs/ACTIVE-DOCS-INDEX.md`](./docs/ACTIVE-DOCS-INDEX.md).
- **V2-015 Production base** — historical planning/runbook material; use [`docs/ACTIVE-DOCS-INDEX.md`](./docs/ACTIVE-DOCS-INDEX.md) for current authority.
