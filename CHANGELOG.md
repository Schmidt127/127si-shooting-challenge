...
#### Changed
- **035 v1.6 live → GitHub sync (2026-09-14)** — Synced Production Automation Code upward into GitHub (**v1.6**, marker `SC-SEASON-SIM-001-DEPLOY-20260913C`). Progressive Settled Through % state machine for threshold re-entry. Automations-table mirror corrected to v1.6 (AI Version field not writable). Evidence: [`docs/audits/readiness-20260914/AUTOMATION-035-053-065-VERSION-SYNC-20260914.md`](./docs/audits/readiness-20260914/AUTOMATION-035-053-065-VERSION-SYNC-20260914.md).
- **065 v10.11 live → GitHub sync (2026-09-14)** — Synced Production Automation Code upward into GitHub (**v10.11**, marker `SC-SEASON-SIM-001-DEPLOY-20260913B`). Includes v10.10 soft-skip when `Total Homework XP Awarded` is not yet positive so premature Needed=1 runs before 064 cannot latch forever. No Production paste. Verify: [`docs/audits/readiness-20260914/065-V10.11-LIVE-SYNC-VERIFY-20260914.md`](./docs/audits/readiness-20260914/065-V10.11-LIVE-SYNC-VERIFY-20260914.md).
- **053 v5.8 Denver-safe week date keys (2026-09-14 sync)** — GitHub synchronized to live Production Automation Code **v5.8** (`SC-SEASON-SIM-001-DEPLOY-20260913B`, updated 2026-09-13). `toDateKey` keeps date-only `YYYY-MM-DD` literally and converts ISO datetime strings via America/Denver (no UTC prefix slice), so Week End stored as next-UTC-morning `05:59Z` does not overlap the next Week Start — unblocks 50/60-day streak occurrence materialization. Automations-table `Version Number - AI Agent` already `v5.8 - 2026-09-13` (no Code/trigger/status change). Evidence: [`docs/audits/053-v5.8-live-sync-20260914/VERIFICATION.md`](./docs/audits/053-v5.8-live-sync-20260914/VERIFICATION.md). Source: [`053-achievements-and-milestones-streak-occurrences-rebuild-and-upsert-from-submissions.js`](./airtable/automations/shooting-challenge/053-achievements-and-milestones-streak-occurrences-rebuild-and-upsert-from-submissions.js).
