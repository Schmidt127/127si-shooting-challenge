...
| 057 | Weekly Athlete Summary | When record matches conditions: `Perfect Week Calculation Queue? = 1` (Pending OR Recalc Needed) | `057-...-calculate-perfect-week-eligibility.js` (**GitHub v2.7; Live v2.6 pending paste** — Week End Saturday homework gate + partial terminal Week) | Perfect week flags |
...
| 076 | Submissions / Enrollments | *confirm* | `076-...-build-daily-submission-email-package.js` (**v8.17**) | Daily email package |
...
| **118** | Weeks / Enrollments | Scheduled Sunday 05:00 America/Denver | `118-...-schedule-weekly-summary-email-build.js` (**v2.3**) | Arms Weekly Athlete Summary email build |
